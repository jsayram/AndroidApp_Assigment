    ...
    private void setUpData() {
        FoodIdenityHolder foodIdenityHolder =
                new FoodIdenityHolder(R.drawable.pancakes, R.string.banana_pancakes,
                        R.string.banana_pancakes_carbs, R.string.banana_pancakes_proteins,
                        R.string.banana_pancakes_veg_fruits);
        FoodIdenityHolder foodIdenityHolder1 =
                new FoodIdenityHolder(R.drawable.kale_hash,
                        R.string.kale_hash, R.string.carbs_kale_hash,
                        R.string.protein_kale_hash, R.string.veg_kale_hash);
