...
public class My_Breakfast_meal_Frag4 extends Fragment {

    /**
     * Returns a new instance of this fragment for the given section
     * number.
     */
    public static My_Breakfast_meal_Frag4 newInstance(int sectionNumber) {
        My_Breakfast_meal_Frag4 fragment = new My_Breakfast_meal_Frag4();
        return fragment;
    }
    //CONSTRUCTOR METHOD for frag
    public My_Breakfast_meal_Frag4() {
    }
                             ...
                             Bundle savedInstanceState)
    {
        ...
        View rootView = inflater.inflate(R.layout.my_breakfast_meal_frag4, container, false);
